...
public class PageService : IPageService
{
    ...
    public PageService(IServiceProvider serviceProvider)
    {
        ...
        Configure<DesToolViewModel, DesToolPage>();
        Configure<DataAnalysisToolViewModel, DataAnalysisToolPage>();
        Configure<UserRegistrationToolViewModel, UserRegistrationToolPage>();
